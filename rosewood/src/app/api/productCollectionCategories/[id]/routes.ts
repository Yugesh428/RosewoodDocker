...
// GET  /api/ui/collection/categories/:id  → get single category (optionally with items)
...
// DELETE /api/ui/collection/categories/:id  → delete category (cascade + image cleanup)
